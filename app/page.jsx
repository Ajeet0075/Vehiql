              ...
              return(
                  ...
                  >
                    <div className="h-16 w-auto mx-auto mb-2 relative">
                      <Image src={make.image} alt={make.name} 
                      fill 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="bg-blue-100 text-blue-700 rounded-full h-16 w-16 flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Verified listings and booking process for peace of mind.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 dotted-background text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of customers who found their perfect vehicle through our platform.
          </p>
